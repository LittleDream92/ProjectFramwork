...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i<2) {
                backView.frame = CGRectMake(i*kScreenWidth/2, 0, kScreenWidth/2, 80);
            }else{
                backView.frame = CGRectMake((i-2)*kScreenWidth/2, 80, kScreenWidth/2, 80);
            }
            backView.tag = 100+i;
            ...
            //标题
            UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 20, kScreenWidth/2-10-60, 30)];
            ...
            //子标题
            UILabel *subTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 40, kScreenWidth/2-10-60, 30)];
            ...
            //图
            UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(kScreenWidth/2-10-60, 10, 60, 60)];
            imageView.tag = 240+i;
