...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier menuArray:(NSMutableArray *)menuArray{
    ...
    if (self) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i < 5) {
                CGRect frame = CGRectMake(i*kScreenWidth/5, 0, kScreenWidth/5, 80);
...
//                CGFloat frameHeight = frame.size.height;
                ...
                CGRect frame = CGRectMake((i-5)*kScreenWidth/5, 80, kScreenWidth/5, 80);
                NSString *title = categoryM.category_name;
                NSString *imageStr1 = categoryM.category_picurl;
                NSString *imageStr = @"icon_homepage_entertainmentCategory";
...
//                CGFloat frameHeight = frame.size.height;
                ...
                CGRect frame = CGRectMake((i-10)*kScreenWidth/5, 0, kScreenWidth/5, 80);
                NSString *title = categoryM.category_name;
                NSString *imageStr1 = categoryM.category_picurl;
                NSString *imageStr = @"icon_homepage_entertainmentCategory";
...
//                CGFloat frameHeight = frame.size.height;
                ...
                CGRect frame = CGRectMake((i-15)*kScreenWidth/5, 80, kScreenWidth/5, 80);
                NSString *title = categoryM.category_name;
                NSString *imageStr1 = categoryM.category_picurl;
                NSString *imageStr = @"icon_homepage_entertainmentCategory";
